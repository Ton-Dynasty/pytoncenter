...
ExtentedAddressInformation = TypedDict("ExtentedAddressInformation", {"@type": Literal["fullAccountState"], "address": AccountAddress, "balance": str, "last_transaction_id": TransactionID, "block_id": BlockID, "sync_utime": int, "account_state": AccountState, "revision": int, "@extra": str})
...
Tx = TypedDict("Tx", {"@type": Literal["raw.transaction"], "address": AccountAddress, "utime": int, "data": str, "transaction_id":TransactionID, "fee": str, "storage_fee": str, "other_fee": str, "in_msg": Message, "out_msgs": List[Message]})
